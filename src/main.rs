...
use hw4::{ApplicationContext, State};

struct Application {
    pub vertex_buffer: glium::vertex::VertexBufferAny,
    pub program: glium::Program,
    pub camera: hw4::camera::CameraState,
    pub diffuse_tex: glium::Texture2d,
}

impl ApplicationContext for Application {
    const WINDOW_TITLE: &'static str = "hw4";

    fn new(display: &Display<WindowSurface>) -> Self {
        let (vertex_buffer, diffuse_texture) = hw4::load_wavefront(&display, include_bytes!("../uploads_files_3569627_maze-32x32.obj"), include_bytes!("../texture.jpg"));
            ...
            140 => {
                ...
                fragment: "
                    ...
                    void main() {
                        ...
                        vec3 color = (0.3 + 0.7 * lum) * ambient_color;
        ...
        let camera = hw4::camera::CameraState::new();
